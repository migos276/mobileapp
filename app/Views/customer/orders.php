<?php
$title = 'Mes Commandes - GazExpress';
$includeMap = false;
...
<div class="dashboard">
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/customer/orders" class="active"><i class="fas fa-list"></i> Mes commandes</a></li>
    ...
    <main class="main-content">
        <div class="content-header">
            <h1>Mes Commandes</h1>
            <p class="breadcrumb">Accueil / Mes commandes</p>
        </div>

        <div class="table-container">
            <div style="padding: 1.5rem; border-bottom: 1px solid var(--border-color);">
                <h3><i class="fas fa-list"></i> Historique de mes commandes</h3>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($orders as $order): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($order['nom_entreprise']) ?></td>
